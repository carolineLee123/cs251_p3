...
public class TestTuple {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (check) {
                ...
                System.out.println("Lexicographic Tests Failed");
    ...
    private static boolean test4() {
       // System.out.println("TEST 4");
        ...
        for (int i = 0; i < 1000 && bool; i++) {
            ...
            String str1 = random.ints(48, 122 + 1)
                    .limit(str1Len)
                    .collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append)
                    .toString();
            Character[] arr1 =
                    str1.chars().mapToObj(c -> (char)c).toArray(Character[]::new);
            Character[] arr2 =
                    str1.chars().mapToObj(c -> (char)c).toArray(Character[]::new);
            Tuple tuple1 = new Tuple(arr1);
            Tuple tuple2 = new Tuple(arr2);
    ...
    private static boolean testString(Tuple tuple1, Tuple tuple2, int maxLength) {
        ...
        String str1 = random.ints(48, 122 + 1)
                ...
                .collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append)
                .toString();
        String str2 = random.ints(48, 122 + 1)
                .limit(str2Len)
                .collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append)
                .toString();
        Character[] arr1 =
                str1.chars().mapToObj(c -> (char)c).toArray(Character[]::new);
        Character[] arr2 =
                str2.chars().mapToObj(c -> (char)c).toArray(Character[]::new);
